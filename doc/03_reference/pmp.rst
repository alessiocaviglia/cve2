...
Default reset values are defined in :file:`vcve2_pmp_reset_default.svh`.
An implementation can either modify this file or define ``CVE2_CUSTOM_PMP_RESET_VALUES`` and place a copy of :file:`vcve2_pmp_result_default.svh` in a new file, :file:`vcve2_pmp_reset.svh`, changing the values as required and adding the new file to the include path of whatever build flow is being used.
